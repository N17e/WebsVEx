...
<div class="title">COMMAND INJECTION QUIZ</div>
<?php 															
						...
						$fetchqry2 = "UPDATE `comlowq` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
	<?php 
	if(isset($c)) {   $fetchqry = "SELECT * FROM `comlowq` where id='$c'"; 
...
<tr>
 ...
 <?php if($_SESSION['clicks']>5){ 
	$qry3 = "SELECT `ans`, `userans` FROM `comlowq`;";
 ...
 <br>
	  ...
	  <br>
	   <input type="button" value="Next Page" class="homebutton" id="btnHome" onClick="location.href = 'commandsecurity.php';" />
