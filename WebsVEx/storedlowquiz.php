...
<div class="title">XSS STORED QUIZ</div>
<?php 															
						...
						$fetchqry2 = "UPDATE `storedlowq` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
	<?php 
	if(isset($c)) {   $fetchqry = "SELECT * FROM `storedlowq` where id='$c'"; 
...
<tr>
 ...
 <?php if($_SESSION['clicks']>5){ 
	$qry3 = "SELECT `ans`, `userans` FROM `storedlowq`;";
