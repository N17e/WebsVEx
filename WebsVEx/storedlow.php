...
<div id="container">
	<div id="header">
		<h1>WebsVEx Low Level XSS DOM Attack</h1>
		<div id ="userinfo">
		<?php
	...
	<div id="content">
		...
		<div id="main">
			<h3>Low Level XSS DOM Attack</h3>
			<br />
			<h3>Objective</h3>
					...
					if( isset( $_REQUEST[ 'Answer' ] ) ) {
						...
						$answerpass = $_REQUEST['passanswer'];
							if($answerpass == "<script>alert(document.cookie)</script>"){?>
								...
								<input type="button" value="Next Page" class="AnswerButton" id="btnHome" onClick="location.href = 'storedlowquiz.php';" />
								<?php
				...
				<br />
					...
					//Function for stored message
					  ...
					  while( $row = mysqli_fetch_row( $result ) ) {
					      ...
					      $comment = $row[1];
					      ?>
					      <div id=guestbook_comments><pre>Name:<?php echo "{$name}"; ?><br />Message: <?php echo "{$comment}" ?><br /></pre></div>
					      <?php
					  }
					  return $message;
