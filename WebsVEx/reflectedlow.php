...
<div id="container">
	<div id="header">
		<h1>WebsVEx Low Level XSS Reflected Attack</h1>
				<div id ="userinfo">
		<?php
	...
	<div id="content">
		...
		<div id="main">
			<h2>Low Level XSS Reflected Attack</h2>
			<br \>
			<h4>Objective</h4>
			<p>Your need cookies to feed your virtual monster. To do that you need use scripting to get user's cookies. To make you monster release the virus, you need steal the cookie of a logged in user.</p>
			<h4>Scenario</h4>
			...
			<?php
				...
				if( array_key_exists( "name", $_GET ) && $_GET[ 'name' ] != NULL ) {
					...
					if($_GET['name'] == "<script>alert(document.cookie)</script>"){
								...
								<input type="button" value="Next Page" class="AnswerButton" id="btnHome" onClick="location.href = 'reflectedlowquiz.php';" />
								<?php
