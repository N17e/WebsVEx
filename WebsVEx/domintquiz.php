...
<?php 															
						...
						$fetchqry2 = "UPDATE `domintq` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
	<?php 
	if(isset($c)) {   $fetchqry = "SELECT * FROM `domintq` where id='$c'"; 
...
<tr>
 ...
 <?php if($_SESSION['clicks']>5){ 
	$qry3 = "SELECT `ans`, `userans` FROM `domintq`;";
 ...
 <br>
	  ...
	  <br>
	   <input type="button" value="Next Page" class="homebutton" id="btnHome" onClick="location.href = 'domsecurity.php';" />
