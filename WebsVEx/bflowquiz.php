...
<div class="title">BRUTE FORCE ATTACK QUIZ</div>
<?php 															
						...
						$fetchqry2 = "UPDATE `bflowq` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
	<?php 
	if(isset($c)) {   $fetchqry = "SELECT * FROM `bflowq` where id='$c'"; 
...
<tr>
 ...
 <?php if($_SESSION['clicks']>5){ 
	$qry3 = "SELECT `ans`, `userans` FROM `bflowq`;";
...
<h2>Result</h2>
 ...
 <span>Your Score:&nbsp<?php echo $no*20; ?>
	  ...
	  <br>
	   <input type="button" value="Next Page" class="NextButton" id="btnHome" onClick="location.href = 'bfsecurity.php';" />
