...
<div class="title">XSS DOM QUIZ</div>
<?php 															
						...
						$fetchqry2 = "UPDATE `domlowq` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
	<?php 
	if(isset($c)) {   $fetchqry = "SELECT * FROM `domlowq` where id='$c'"; 
...
<tr>
 ...
 <?php if($_SESSION['clicks']>5){ 
	$qry3 = "SELECT `ans`, `userans` FROM `domlowq`;";
