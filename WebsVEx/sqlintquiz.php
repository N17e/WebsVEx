...
<div class="title">SQL INJECTION QUIZ</div>
<?php 															
						...
						$fetchqry2 = "UPDATE `sqllowq` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
	<?php 
	if(isset($c)) {   $fetchqry = "SELECT * FROM `sqllowq` where id='$c'"; 
...
<tr>
 ...
 <?php if($_SESSION['clicks']>5){ 
	$qry3 = "SELECT `ans`, `userans` FROM `sqllowq`;";
 ...
 <br>
	  ...
	  <br>
	   <input type="button" value="Next Page" class="NextButton" id="btnHome" onClick="location.href = 'sqlsecurity.php';" />
