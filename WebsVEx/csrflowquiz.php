...
<div class="title">CSRF INJECTION QUIZ</div>
<?php 															
						...
						$fetchqry2 = "UPDATE `csrflowq` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
	<?php 
	if(isset($c)) {   $fetchqry = "SELECT * FROM `csrflowq` where id='$c'"; 
...
<tr>
 ...
 <?php if($_SESSION['clicks']>5){ 
	$qry3 = "SELECT `ans`, `userans` FROM `csrflowq`;";
 ...
 <br>
	  ...
	  <br>
	   <input type="button" value="Next Page" class="homebutton" id="btnHome" onClick="location.href = 'csrfsecurity.php';" />
