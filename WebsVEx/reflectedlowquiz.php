...
<?php 															
						...
						$fetchqry2 = "UPDATE `reflowq` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
	<?php 
	if(isset($c)) {   $fetchqry = "SELECT * FROM `reflowq` where id='$c'"; 
...
<tr>
 ...
 <?php if($_SESSION['clicks']>5){ 
	$qry3 = "SELECT `ans`, `userans` FROM `reflowq`;";
 ...
 <br>
	  ...
	  <br>
	   <input type="button" value="Next Page" class="homebutton" id="btnHome" onClick="location.href = 'reflectedsecurity.php';" />
